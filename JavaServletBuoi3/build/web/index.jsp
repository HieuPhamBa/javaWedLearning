<%@page import="com.sun.xml.rpc.tools.wscompile.UsageIf"%>
<!DOCTYPE html>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                       <% try{
                            ...
                            %> <tr>
                            <td><%=rs.getInt("id")%></td>
                            <td><%=rs.getString("NameSv")%></td>
                            <td><%=rs.getString("email")%></td>
                            <td>
                                <a class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
                                <a class="edit" title="Edit" data-toggle="tooltip" href="./Edit.jsp"><i class="material-icons">&#xE254;</i></a>
                                <a class="delete" title="Delete" data-toggle="tooltip" href="Delete%>"><i class="material-icons">&#xE872;</i></a>
                            </td> </tr>
